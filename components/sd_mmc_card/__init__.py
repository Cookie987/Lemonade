...
@automation.register_action(
    ...
    SdMmcWriteFileAction,
    SD_MMC_WRITE_FILE_ACTION_SCHEMA,
    synchronous=True,
)
...
@automation.register_action(
    ...
    SdMmcCreateDirectoryAction,
    SD_MMC_PATH_ACTION_SCHEMA,
    synchronous=True,
)
